...
public class FragmentDeletedAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private OnItemClickListener onItemClickListener;
    private List<MessagesData> messagesDataList;

    public FragmentDeletedAdapter(List<MessagesData> messagesDataList) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        String mobileNumber;
        String content;
            content = messagesDataList.get(position).getContent();
            mobileNumber = messagesDataList.get(position).getClientMobileNumber();
            dateSent = messagesDataList.get(position).getDateSent();
