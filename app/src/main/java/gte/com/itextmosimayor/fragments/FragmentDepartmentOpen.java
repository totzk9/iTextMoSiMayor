...
public class FragmentDepartmentOpen extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private FragmentDepartmentMessagesAdapter fragmentOpenAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        refreshBadge(viewModel.getOpenMessages().getValue().size());
        return view;
    }
    ...
    public void initializeRecyclerView() {
        fragmentOpenAdapter = new FragmentDepartmentMessagesAdapter(viewModel.getOpenMessages().getValue());
        fragmentOpenAdapter.setOnItemClickListener(new FragmentDepartmentMessagesAdapter.OnItemClickListener() {
            @Override
