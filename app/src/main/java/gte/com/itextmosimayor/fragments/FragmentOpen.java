...
import gte.com.itextmosimayor.adapter.FragmentOpenAdapter;
...
public class FragmentOpen extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    FragmentOpenAdapter fragmentOpenAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        fragmentOpenAdapter = new FragmentOpenAdapter(getContext(), c);
