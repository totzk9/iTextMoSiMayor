...
public class FragmentDepartmentOpenAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context context;
    Cursor cursor;
    private OnItemClickListener onItemClickListener;

    public FragmentDepartmentOpenAdapter(Context context, Cursor cursor ){
